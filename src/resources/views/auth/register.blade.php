        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                <div class="text-center mb-4">
                    ...
                    <h3 class="fw-bold" style="color: #211c33;">Crie sua conta</h3>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0" style="border-color: #ffe0c0;"><i class="fas fa-user" style="color: #2b818c;"></i></span>
                                <input id="name" type="text" class="form-control bg-light border-start-0 @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required placeholder="João Silva" style="border-color: #ffe0c0;">
                            </div>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input id="email" type="email" class="form-control bg-light border-start-0 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required placeholder="seu@email.com" style="border-color: #ffe0c0;">
                            </div>
                            @error('email')
                            <span class="text-danger small mt-1">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0" style="border-color: #ffe0c0;"><i class="fas fa-check" style="color: #2b818c;"></i></span>
                                <input id="password-confirm" type="password" class="form-control bg-light border-start-0" name="password_confirmation" required placeholder="••••••••" style="border-color: #ffe0c0;">
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('login') }}" class="text-decoration-none fw-bold" style="color: #ed2860;">Entrar</a>
                        </div>
                    </form>
                </div>
            </div>
