<div>
    <x-slot name="header_title">Novo Livro (Livewire)</x-slot>
            ...
            <div class="card-modern p-4 shadow-sm border-0" style="border-radius: 20px;">
                <div class="d-flex align-items-center gap-3 mb-4">
                    <div class="rounded-3 d-flex align-items-center justify-content-center" style="width: 56px; height: 56px; background: #1E4A7A; color: white;">
                        <i class="fas fa-book-plus fa-2x"></i>
                    </div>
                    <div>
                        <h4 class="fw-bold mb-1" style="color: #1e2b3c;">Adicionar Livro</h4>
                        <p class="text-muted mb-0">Preencha os detalhes do novo livro em tempo real</p>
                    </div>
                </div>
